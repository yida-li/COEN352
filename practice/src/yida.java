...
public class yida {
	...
	public static void main(String[] args) {
		...
		// run as- configuration -> input arguments to args only for eclipse IDE
		for (int i = 0; i < args.length; i++) // a for loop from 0 to length of args in terms of how many string char it
												// holds?
